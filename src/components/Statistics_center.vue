...
export default {
  ...
  data () {
    return {
      ...
      label6:'维修时间',
      columns6:['1天','2天','3天','4天','5天','6天','7天','8天','9天','10天','11天','12天','13天','14天','15天','16天','17天','18天','19天','20天','21天','22天','23天','24天','25天','26天','27天','28天','29天','30天'],
      ...
      tableColumn: [
        ...
        { field: 'id', title: '维修单号',width: 65},
        { field: 'startTime', title: '报修时间', showOverflow: true, 
          slots: 
            {
              
              default: ({ row }) => {
                return [
                  <p class="link" style="color: red;text-align:center" onClick={()=>this.onClickNotCompleted(row)}>{ row.startTime }</p>
                ]
              }, 
            },
        },
